...
#ifndef LXD_BERTHING_INFOMATION_OUTLIER_NOISE_FILTERING_H
#define LXD_BERTHING_INFOMATION_OUTLIER_NOISE_FILTERING_H
...
public:
    ...
    void Port_filtering(pcl::PointCloud<pcl::PointXYZ>::Ptr curret_cloud_ptr){
...
#endif //LXD_BERTHING_INFOMATION_OUTLIER_NOISE_FILTERING_H
